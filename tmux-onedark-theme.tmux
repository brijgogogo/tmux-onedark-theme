...
set "status-left" "#[fg=$onedark_white,bg=$onedark_black,bold] #S#{prefix_highlight}#[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]"
